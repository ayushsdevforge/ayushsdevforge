...
const ayush = {
    pronouns: "he" | "him",
    education: "B.Tech in Computer Science & Engineering @ SISTec, Bhopal",
    currentFocus: "Building scalable full-stack applications",
    funFact: "District topper in Science Olympiad 🏆",
    hobbies: ["Trekking 🏔️", "Hitchhiking 🚗", "Adventure Travel ✈️"]
};
```
